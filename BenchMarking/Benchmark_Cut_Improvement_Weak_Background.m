...
% Weak background and one cluster
% Daniel Mckenzie
% October 21st 2019
% ==================================================================== %
...
for j = 1:num_sizes
    ...
    for i = 1:num_trials
        ...
        L = speye(n,n) - DinvA;
        tic
        [C1_CP,~] = ClusterPursuit(L,Gamma,Omega,ceil(0.16*n1),reject);
        time_CP_mat(i,j) = toc;
...
legend({'SimpleLocal','FlowImprove','RWT','ClusterPursuit'},'FontSize',14)
...
legend({'SimpleLocal','FlowImprove','ClusterPursuit'},'FontSize',14)
