% ================================================================= %
% Test Experiment on SBM with many, differently sized clusters.
% Daniel Mckenzie
% May 2019
% ================================================================= %
...
figure, hold on
plot(Cluster_sizes,mean(Jaccard_HKGrow_mat,1),'LineWidth',3)
plot(Cluster_sizes,mean(Jaccard_PPR_mat,1),'LineWidth',3)
plot(Cluster_sizes,mean(Jaccard_RWT_mat,1),'LineWidth',3)
plot(Cluster_sizes,mean(Jaccard_LBSA_mat,1),'LineWidth',3)
...
plot([300:100:700],log(mean(time_LBSA_mat,1)),'LineWidth',3)
